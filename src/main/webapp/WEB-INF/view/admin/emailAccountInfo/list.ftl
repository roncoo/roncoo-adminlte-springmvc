...
<div class="content-wrapper">
	<div class="row">
		<div class="col-md-12">
            ...
            <div class="box-body">
            	<div class="clearfix">
            		<form id="search-form" action="${ctx}/admin/emailAccountInfo/list" method="post">
						<div class="col-md-4">
						...
						<div class="col-md-4">
							<div class="input-group">
								...
								<input type="text" class="form-control input-sm" id="search" name="search" value="${param['search']!}" placeholder="根据账号搜索...">
							</div>
						</div>
						<div class="col-md-4">
                ...
                <tbody>
                	<#list page.list as bean>
	                	<tr>
	                		...
	                		<td style="width:25%;">
	                			<a class="btn btn-primary btn-sm" href="${ctx}/admin/emailAccountInfo/view?id=${bean.id}">查看</a>
								<a class="btn btn-twitter btn-sm" href="${ctx}/admin/emailAccountInfo/edit?id=${bean.id}">修改</a>
								<a class="btn btn-danger btn-sm" onClick="delcfm('${ctx}/admin/emailAccountInfo/delete?id=${bean.id}')">删除</a>
	                		</td>
	                	</tr>
                	</#list>
              	</tbody>
