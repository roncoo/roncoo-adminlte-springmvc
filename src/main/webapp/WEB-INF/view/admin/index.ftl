			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						<a href="#">
							<i class="fa fa-dashboard"></i> <span>报表</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li class="active">
								<a href="/include/dashboard.html">
									<i class="fa fa-circle-o"></i> 报表 v1
								</a>
							</li>
							<li>
								<a href="/include/dashboard2.html">
									<i class="fa fa-circle-o"></i> 报表 v2
								</a>
							</li>
						</ul>
					</li>
					<li class="treeview">
						<a href="/include/layout.html">
							<i class="fa fa-files-o"></i> <span>界面布局</span> <span class="pull-right-container"> <span class="label label-primary pull-right">4</span>
							</span>
						</a>
					</li>
					<li>
						<a href="/include/widgets.html">
							<i class="fa fa-th"></i> <span>窗口小部件</span> <span class="pull-right-container"> <small class="label pull-right bg-green">new</small>
							</span>
						</a>
					</li>
					<li class="treeview">
						<a href="#">
							<i class="fa fa-pie-chart"></i> <span>图表</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li>
								<a href="/include/charts/chartjs.html">
									<i class="fa fa-circle-o"></i> ChartJS
								</a>
							</li>
							<li>
								<a href="/include/charts/morris.html">
									<i class="fa fa-circle-o"></i> Morris
								</a>
							</li>
							<li>
								<a href="/include/charts/flot.html">
									<i class="fa fa-circle-o"></i> Flot
								</a>
							</li>
							<li>
								<a href="/include/charts/inline.html">
					...
					<li class="treeview">
						<a href="#">
							<i class="fa fa-laptop"></i> <span>UI 元素</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li>
								<a href="/include/UI/general.html">
									<i class="fa fa-circle-o"></i> 一般
								</a>
							</li>
							<li>
								<a href="/include/UI/icons.html">
									<i class="fa fa-circle-o"></i> 图标
								</a>
							</li>
							<li>
								<a href="/include/UI/buttons.html">
									<i class="fa fa-circle-o"></i> 按钮
								</a>
							</li>
							<li>
								<a href="/include/UI/sliders.html">
									<i class="fa fa-circle-o"></i> 滑块
								</a>
							</li>
							<li>
								<a href="/include/UI/timeline.html">
									<i class="fa fa-circle-o"></i> 时间表
								</a>
							</li>
							<li>
								<a href="/include/UI/modals.html">
									<i class="fa fa-circle-o"></i> 动态提示
								</a>
							</li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#">
							<i class="fa fa-edit"></i> <span>表单</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li>
								<a href="/include/forms/general.html">
									<i class="fa fa-circle-o"></i> 一般元素
								</a>
							</li>
							<li>
								<a href="/include/forms/advanced.html">
									<i class="fa fa-circle-o"></i> 高级元素
								</a>
							</li>
							<li>
								<a href="/include/forms/editors.html">
					...
					<li class="treeview">
						<a href="#">
							<i class="fa fa-table"></i> <span>表格</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li>
								<a href="/include/tables/simple.html">
									<i class="fa fa-circle-o"></i> 简单表格
								</a>
							</li>
							<li>
								<a href="/include/tables/data.html">
					...
					<li>
						<a href="/include/calendar.html">
							<i class="fa fa-calendar"></i> <span>日历</span> <span class="pull-right-container"> <small class="label pull-right bg-red">3</small> <small class="label pull-right bg-blue">17</small>
							</span>
						</a>
					</li>
					<li  class="treeview">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li>
								<a href="javascript:void(0);">
									<i class="fa fa-circle-o"></i> 一级菜单 <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i>
									</span>
								</a>
								<ul class="treeview-menu">
									<li>
									...
									<li>
										<a href="javascript:void(0);">
											<i class="fa fa-circle-o"></i> 二级菜单 <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i>
											</span>
										</a>
										<ul class="treeview-menu">
											<li>
												<a href="javascript:void(0);">
													<i class="fa fa-circle-o"></i> 三级菜单
												</a>
											</li>
											<li>
												<a href="javascript:void(0);">
					...
					<li>
						<a href="include/documentation.html">
							<i class="fa fa-book"></i> <span>文档</span>
						</a>
					</li>
					...
					<li>
						<a href="javascript:void(0);">
							<i class="fa fa-circle-o text-aqua"></i> <span>消息</span>
						</a>
					</li>
				</ul>
			</section>
