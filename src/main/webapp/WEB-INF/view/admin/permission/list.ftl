	...
	<div class="row">
		<div class="col-md-12">
			<div class="box">
				...
				<div class="box-body">
					<div class="clearfix">
	            		<form id="search-form" action="${ctx}/admin/permission/list" method="post">
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="input-group">
									...
									<input type="text" class="form-control input-sm" id="search" name="search" value="${param['search']!}" placeholder="根据权限搜索...">
								</div>
							</div>
							<div class="col-md-4">
						...
						<tbody>
							<#list page.list as bean>
								<tr>
									...
									<td>
										<a class="btn btn-sm btn-primary" href="${ctx}/admin/permission/view?id=${bean.id}">查看</a>
										<a class="btn btn-twitter btn-sm" href="${ctx}/admin/permission/edit?id=${bean.id}">修改</a>
										<a class="btn btn-danger btn-sm" onClick="delcfm('${ctx}/admin/permission/delete?id=${bean.id}')">删除</a>
									</td>
								</tr>
							</#list>
						</tbody>
				...
				<!-- /.box-body -->
				<@initPage url="${ctx}/admin/permission/list" paginationSize=5/>
			</div>
		</div>
	</div>
</div>
